...
Symbolic Execution (\gsetxt{}). Intuitively, any properties proven with~\gsetxt{}
can also be proved using the symbolic heap algorithm.~\gsetxt{} concretizes
...
\gsetxt{} are shown in the~\appref{app:gse}.
