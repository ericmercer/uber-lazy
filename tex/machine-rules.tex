...
\and
	\inferrule[Field Access (non-NULL)]{
      ...
      \rho = \{ r_a |  l_a\in L \wedge \mathrm{type}(l_a) = \mathrm{C}_r \wedge r_a = R(l_a,\omega)\} \\\\
      \theta_a = \{ ( l_a ,\ \phi_a ) | l_a\in L \wedge \mathrm{type}(l_a) = \mathrm{C}_r \wedge r_a = R(l_a,\omega) \wedge \phi_a = (r = r_a) \} \\\\
      \theta_f = \{(l,\wedge_{r_a \in \rho} r \ne r_a)\}\\ 
      \theta_t = \theta_a \cup \theta_f \\\\
      R^\prime = R[\forall \mathrm{f} \in \mathrm{C}_r\ ((l\ \cfgnt{f}) \mapsto \mathrm{fresh}_r(\mathrm{type}(\cfgnt{f})))]
    }{
      (L\ R\ \eta\ r\ (*\ \$\ \cfgnt{f} \rightarrow k)) \rightarrow 
      (L[r \mapsto \theta_t]\ R^\prime\ \eta\ r\ (*\ \$\ \cfgnt{f} \rightarrow k))
	}
\and
	\inferrule[New]{
...
\and
    ...
    \theta_0 = \{\phi_0 \mid \exists (l_0\ \phi_0) \in L(v_0) \wedge \forall (l_1\ \phi_1) \in L(v_1)(l_0 \neq l_1)\} \\\\
    \theta_1 = \{\phi_1 \mid \exists (l_1\ \phi_1) \in L(v_1) \wedge \forall (l_0\ \phi_0) \in L(v_0)(l_0 \neq l_1)\} \\\\
    \phi_g = (\wedge_{\phi_\alpha\in\theta_\alpha}\phi_\alpha)\wedge((\vee_{\phi_0 \in \theta_0} \phi_0)  \vee(\vee_{\phi_1
    \in \theta_1} \phi_1)) \\\\
      L^\prime = L[\forall r (\exists (\cfgnt{l}\ \phi )\in L(r)(r \mapsto \mathbb{ST}(L,r,\phi_g)))]\\\\
      X = \mathbb{ER}(L, \phi_g) \\ \mathbb{C}(L^\prime, R, X, \eta, k) = 1}{
    (L\ R\ \eta\ \cfgnt{v}_0\ (\cfgnt{v}_1\; \cfgt{=}\; \cfgt{*} \rightarrow \cfgnt{k})) \rightarrow
...
\and
   \inferrule[Method Invocation (object eval)]{}{
    (L\ R\ \eta\ \lp\cfgnt{e}_0\ \cfgt{@}\ \cfgnt{m}\ \cfgnt{e}_1\rp\ \cfgnt{k}) \rightarrow
    (L\ R\ \eta\ \cfgnt{e}_0\ (\cfgt{*}\ \cfgt{@}\ \cfgnt{m}\ \cfgnt{e}_1\ \rightarrow \cfgnt{k}))
   }
   
\and
   \inferrule[Method Invocation (arg eval)]{}{
    (L\ R\ \eta\ \cfgnt{v}_0\ (\cfgt{*}\ \cfgt{@}\ \cfgnt{m}\ \cfgnt{e}_1\ \rightarrow \cfgnt{k})) \rightarrow
    (L\ R\ \eta\ \cfgnt{e}_1\ (\cfgnt{v}_0\ \cfgt{@}\ \cfgnt{m}\ \cfgt{*}\ \rightarrow \cfgnt{k}))
   }
%\and
...
\and
   \inferrule[Method Invocation (raw)]{
    ...
    (L\ R\ \eta\ \cfgnt{v}_1\ (\cfgnt{v}_0\ \cfgt{@}\ \cfgnt{m}\ \cfgt{*}\ \rightarrow \cfgnt{k})) \rightarrow
    (L\ R\ \eta\ (\cfgt{raw}\ \cfgnt{v}_0\ \cfgt{@}\ \cfgnt{m}\ \cfgnt{v}_1\ \cfgnt{k})
   }
\and
...
\and
	...
	r_x = \eta(\cfgnt{x})\\
      L(r_x) = \emptyset \\
      \mathrm{type}(r_x) = \mathrm{C}_r\\
      \mathrm{fresh}_l(\mathrm{C}_r) = l \\\\
      \rho = \{ r_a |  l_a\in L \wedge \mathrm{type}(l_a) = \mathrm{C}_r \wedge r_a = R(l_a,\omega)\} \\\\
      \theta_a = \{ ( l_a\ \phi_a ) | l_a\in L \wedge \mathrm{type}(l_a) = \mathrm{C}_r \wedge r_a = R(l_a,\omega) \wedge \phi_a = (r_x = r_a) \} \\\\
      \theta_f = {(l,\wedge_{r_a \in \rho} r_x \ne r_a)}\\ 
      \theta_t = \theta_a \cup \theta_f \\\\
      R^\prime = R[\forall \mathrm{f} \in \mathrm{C}_r\ ((l\ \cfgnt{f}) \mapsto \mathrm{fresh}_r(\mathrm{type}(\cfgnt{f})))]
    }{
      (L\ R\ \eta\ \cfgnt{r}\ (\cfgnt{x}\ \cfgt{\$}\ \cfgnt{f}\ \cfgt{:=}\ \cfgnt{*})\ \rightarrow\ k) \rightarrow 
      (L[r_x \mapsto \theta_t]\ R^\prime\ \eta\ \cfgnt{r}\ (\cfgnt{x}\ \cfgt{\$}\ \cfgnt{f}\ \cfgt{:=}\ \cfgnt{*})\ \rightarrow\ k))
	}	
\and
	\inferrule[Field Write]{
      L(r) \neq \emptyset \\ r_x = \eta(\cfgnt{x}) \\
...
\and
   \inferrule[Pop]{}{
    (L\ R\ \eta\ (\cfgt{pop}\ \eta_0\ \cfgnt{k})) \rightarrow
    (L\ R\ \eta_0\ \cfgnt{k})
   }
\end{mathpar}
\end{center}
