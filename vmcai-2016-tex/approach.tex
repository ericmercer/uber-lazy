...
\label{sec:precise}
Although the case-splitting methods used in~\gsetxt{} can be applied
to guarded value sets, a direct implementation would run into the same
path explosion problems. This work presents a new initialization scheme which avoids the
...
The initialization rule in \figref{fig:symInit} is invoked whenever 
