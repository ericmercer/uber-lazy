...
\end{lemma}
\begin{proof}
Induction over the number of machine steps on the symbolic initialization machine in \figref{fig:symInit}.
...
left side of $\rsum$ is location mutual exclusive, and by the
...
$(\cfgnt{L}_\sym^\prime\ \cfgnt{R}_\sym^\prime) =
\mathrm{heap}(s_\sym^\prime)$, is also deterministic.
\end{proof}
...
\end{theorem}
\begin{proof}
Proof by \lemref{FA-determ}, \lemref{FW-determ}, and \lemref{J-determ}
