...
In this work, we present a technique for heap summarization,
...
\item\textbf{-} Show the existence of a bisimulation relation to prove
...
\noindent{In this paper, we present a brief overview of a Java-like
  language and the encoding of heaps as a bipartiate graph. We use the
  Java-like language to define the formal semantics of the heap
  summary machine and then prove the existence of a bisumulation
  relation. Finally we present an evaluation of the heap summary
  approach. }
