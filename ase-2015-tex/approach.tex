...
Application of complex method invariants is facilitated by repOk-style methods as described in~\cite{boyapati2002korat}.
...
%-Valuations
%-Each valuation causes exactly one constraint per reference to evaluate to Òtrue"
