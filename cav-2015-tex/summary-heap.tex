...
A key property of the summary heap is that although many auxiliary or
stack literals are created in symbolic execution with lazy
initialization, only input heap references appear in constraints. A solver reasons over the
