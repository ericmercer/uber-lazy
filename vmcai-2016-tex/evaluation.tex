...
To resolve this question, a prototype of the \symtxt{} 
algorithm was developed in the Symbolic PathFinder (SPF)~\cite{DBLP:journals/ase/PasareanuVBGMR13} framework
to evaluate its efficacy on Java data structure artifacts.
...
algorithms, respectively. The results for
the Lazier algorithm are omitted because they are nearly identical to the Lazier\#
