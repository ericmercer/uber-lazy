...
In this work, in order to effectively represent multiple heaps
simultaneously in the context of symbolic execution we define a novel
heap representation and an algorithm to initialize and update the heap
