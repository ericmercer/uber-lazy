...
\begin{mathpar}
	\inferrule[Field Access]{
      ...
      \lp \cfgnt{L}\ \cfgnt{R}\ \phi_g\ \cfgnt{r}\ \cfgnt{f}\ \cfgnt{C}\rp \rightarrow^*_I 
...
\and
    ...
    \lp \cfgnt{L}\ \cfgnt{R}\ \phi_g\ \eta\ \cfgnt{r}_0\ \lp \cfgnt{r}_1\ \cfgt{=}\ \cfgt{*} \rightarrow \cfgnt{k}\rp \rp  \rightarrow_\ell \\\\
...
\end{mathpar}
\end{center}
\caption{GSE with lazy initialization indicated by $\rightarrow_\ell$.}
\label{fig:lazy}
\end{figure*}
