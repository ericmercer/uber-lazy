...
\begin{mathpar}
	\inferrule[Field Access]{
      ...
      \theta = \{ \phi \mid \lp \phi\ l_\mathit{null}\rp \in \cfgnt{L}\lp\cfgnt{r}\rp \wedge \mathbb{S}\lp \phi \wedge \phi_g\rp \} \\\\
...
\and
	\inferrule[Field Write]{
      ...
      \theta = \{ \phi \mid \lp \phi\ l_\mathit{null} \rp \in \cfgnt{L}\lp\cfgnt{r}_x\rp \wedge \mathbb{S}\lp \phi \wedge \phi_g\rp \} \\\\
      \phi_g^\prime = \phi_g \wedge (\wedge_{\phi \in \theta} \neg \phi) \\\\
