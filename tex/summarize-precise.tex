...
\begin{mathpar}
	...
	\Lambda = \mathbb{UN}\lp \cfgnt{L}, \cfgnt{R}, \cfgnt{r}, \cfgnt{f}\rp \\
      ...
      \theta_\mathit{un} = \{ \lp \phi\ \cfgnt{l}_\mathit{un} \rp \mid \phi = \neg \phi_x \wedge \} \\\\
      \theta_\mathit{null} = \{ \lp \phi\ l_\mathit{null}\rp  \mid \phi = \phi_x \wedge \lp \cfgnt{r}_f = \cfgnt{r}_\mathit{null}\rp   \} \\\\
      \theta_\mathit{new} = \{\lp \phi\ l_f\rp  \mid \phi = \phi_x \wedge \lp \cfgnt{r}_f \neq \cfgnt{r}_\mathit{null} \wedge \lp \wedge_{\lp \cfgnt{r}^\prime_a,\ \phi^\prime_a,\ l^\prime_a\rp  \in \rho} \cfgnt{r}_f \ne \cfgnt{r}^\prime_a\rp \rp \}\\\\
      ...
      \theta = \theta_\mathit{un} \cup \theta_\mathit{alias} \cup \theta_\mathit{new} \cup \theta_\mathit{null} \\
      \lp \phi_x\ \cfgnt{l}_x \rp = \mathrm{min}_l\lp \Lambda\rp 
    }{
      \lp \cfgnt{L}\ \cfgnt{R}\ \cfgnt{r}\ \cfgnt{f}\rp \rightarrow_S 
      \lp \cfgnt{L}[\cfgnt{r}_f \mapsto \theta]\ \cfgnt{R}^\prime[ \lp l_x,\cfgnt{f}\rp  \mapsto \cfgnt{r}_f ]\ \cfgnt{r}\ \cfgnt{f}\ \rp
	}
\and
