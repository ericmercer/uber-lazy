...
\begin{mathpar}
	\inferrule[Lazy Initialization (null)]{
      ...
      \lp \cfgnt{L}\ \cfgnt{R}\ \phi_g\ \cfgnt{r}\ \cfgnt{f}\rp  \rightarrow_L 
...
\and
	\inferrule[Lazy Initialization (new)]{
      ...
      \rho = \{ \lp\cfgnt{r}_a\ l_a\rp \mid \mathrm{isInit}\lp \cfgnt{r}_a\rp  \wedge \exists \phi_a\ \lp \lp \phi_a\ l_a\rp  \in \cfgnt{L}\lp \cfgnt{r}_a\rp  \wedge \mathrm{type}\lp l_a\rp  = \mathrm{C}\rp \}\\\\
...
for generalized symbolic execution with lazy initialization denoted by $\rightarrow_L$.}
\label{fig:expr:lazyInit}
\end{figure*}
...
\and
	\inferrule[Field Write]{
      ...
      l \neq \cfgnt{l}_\mathit{null}\\\\
      \lp \cfgnt{L}\ \cfgnt{R}\ \phi_g\ \cfgnt{r}_x\ \cfgnt{f}\rp \rightarrow^*_L 
