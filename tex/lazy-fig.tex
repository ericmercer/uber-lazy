...
\and
	\inferrule[Field Write]{
      ...
      \lp \cfgnt{L}[\cfgnt{r}^\prime \mapsto \theta]\ \cfgnt{R}[\lp l\ \cfgnt{f}\rp  \mapsto \cfgnt{r}^\prime]\ \phi_g^\prime\ \eta\ \cfgnt{r}\ \cfgnt{k}\rp 
	}	
\and
...
\end{mathpar}
\end{center}
\caption{GSE with lazy initialization.}
\label{fig:lazy}
\end{figure*}
