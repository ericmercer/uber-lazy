...
$$
The $\rgse$ relation over sets of states is $\rsgse = \hookrightarrow_\ell \wedge \hookrightarrow_\com$, and 
...
\forall Q^\prime\ ( Q \rssym Q^\prime\Rightarrow \exists P^\prime\ ( (P \rsgse P^\prime )\wedge (P^\prime\ \sqsubset\ P^\prime )))
\end{equation}
