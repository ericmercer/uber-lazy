...
An ideal symbolic model should be sound, complete, and efficient. We define these terms, and their relation to existing symbolic reference models, as follows:
