...
\emph{immutable references}, \emph{determinism}, \emph{type
  consistency}, and \emph{null and uninitialized}.

\emph{Reference partitions} are new references drawn from
...
\emph{Immutable references} means that a reference does not change in the
