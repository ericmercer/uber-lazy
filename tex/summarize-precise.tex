...
\end{mathpar}
\end{center}
\caption{The summary machine, $s ::= \lp\cfgnt{L}\ \cfgnt{R}\ \cfgnt{r}\ \cfgnt{f}\rp$, with $s\rightarrow_I^*s^\prime$ indicating repeated rewrites until the state does not change.}
\label{fig:symInit}
\end{figure*}
