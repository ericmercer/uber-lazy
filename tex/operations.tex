...
There is a constraint from the base reference and a given
...
Strengthening in the field write creates a value set the
...
\noindent{The equals references-false is the logical dual of the
  reference-true rewrite rule. The references-false is also shown
  in~\figref{fig:eqs}.}
