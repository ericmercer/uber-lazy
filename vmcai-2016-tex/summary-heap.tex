...
Symbolic execution semantics are defined using
...
references correspond to the guarded value sets returned by the $\cfgnt{L}$ function, and 
...
machine halts if no rewrite is enabled.
