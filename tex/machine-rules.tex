...
\begin{mathpar}
	\inferrule[Lazy Initialization (null)]{
	  \{ l \mid \exists \phi\ \lp \lp \phi\ l\rp  \in \cfgnt{L}\lp \cfgnt{r}\rp  \wedge  \cfgnt{R}\lp l,\cfgnt{f}\rp  = \bot\ \rp\} = \Lambda\\
      \emptyset  \neq \Lambda\\\\
      \mathrm{fresh}_r\lp \rp  = \cfgnt{r}^\prime\\ 
      \{ \lp \phi_T\ l_\mathit{null}\rp \} = \theta_\mathit{null} \\
      \mathrm{min}_l\lp \Lambda\rp = l_x\\\\
      \phi_g \wedge \lp\cfgnt{r}^\prime = \cfgnt{r}_\mathit{null}\rp = \phi_g^\prime
    }{
      \lp \cfgnt{L}\ \cfgnt{R}\ \phi_g\ \eta\ \cfgnt{r}\ \lp \cfgt{init}\ \cfgnt{f}\ \cfgnt{k}\rp \rp  \rightarrow \\\\
      \lp \cfgnt{L}[\cfgnt{r}^\prime \mapsto \theta_\mathit{null}]\ \cfgnt{R}[ \lp l_x,\cfgnt{f}\rp  \mapsto \cfgnt{r}^\prime]\ \phi_g^\prime\ \eta\ \cfgnt{r}\ \cfgnt{k}\rp 
	}
\and
	\inferrule[Lazy Initialization (new)]{
	  \{ l \mid \exists \phi\ \lp \lp \phi\ l\rp  \in \cfgnt{L}\lp \cfgnt{r}\rp  \wedge  \cfgnt{R}\lp l,\cfgnt{f}\rp  = \bot\rp\} = \Lambda \\
      \emptyset \neq \Lambda \\\\
      \mathrm{type}\lp \cfgnt{f}\rp  = \mathrm{C}\\
      \mathrm{init}_l\lp \mathrm{C}\rp  = l_f \\
      \mathrm{init}_r\lp \rp  = \cfgnt{r}_f\\\\
      \{ \cfgnt{r}^\prime \mid \mathrm{isInit}\lp \cfgnt{r}^\prime\rp  \wedge \exists \lp\phi^\prime\ l^\prime\rp \in \cfgnt{L}\lp\cfgnt{r}^\prime\rp\ \lp\mathrm{type}\lp l^\prime\rp  = \mathrm{C}\rp \} = \rho \\\\
      \{\lp \phi_T\ l_f\rp \} = \theta_\mathit{new} \\
      \mathrm{min}_l\lp \Lambda\rp = l_x \\\\
      \phi_g \wedge \cfgnt{r}_f \neq \cfgnt{r}_\mathit{null} \wedge \lp \wedge_{\cfgnt{r}^\prime \in \rho} \cfgnt{r}_f \ne \cfgnt{r}^\prime\rp = \phi_g^\prime
    }{
      \lp \cfgnt{L}\ \cfgnt{R}\ \phi_g\ \eta\ \cfgnt{r}\ \lp \cfgt{init}\ \cfgnt{f}\ \cfgnt{k}\rp \rp  \rightarrow \\\\
      \lp \cfgnt{L}[\cfgnt{r}_f \mapsto \theta_\mathit{new}]\ \cfgnt{R}[ \lp l_x,\cfgnt{f}\rp  \mapsto \cfgnt{r}_f ]\ \phi_g^\prime\ \eta\ \cfgnt{r}\ \cfgnt{k}\rp 
	}
\and
	\inferrule[Lazy Initialization (alias)]{
      ...
      \mathrm{type}\lp \cfgnt{f}\rp  = \mathrm{C}\\
      \mathrm{fresh}_r\lp \rp  = \cfgnt{r}^\prime\\\\
      \{ \lp\cfgnt{r}_f\ l^{\prime}\rp \mid \mathrm{isInit}\lp \cfgnt{r}_f\rp  \wedge \exists \phi^{\prime}\ \lp \lp \phi^{\prime}\ l^{\prime}\rp  \in \cfgnt{L}\lp \cfgnt{r}_f\rp  \wedge \mathrm{type}\lp l^{\prime}\rp  = \mathrm{C}\rp \} = \rho \\\\
      \lp\cfgnt{r}_f\ l^\prime\rp \in \rho \\
      \{ \lp \phi_T\ l^\prime\rp\} = \theta_\mathit{alias}\\
      \mathrm{min}_l\lp \Lambda\rp = l_x\\\\
      \phi_g \wedge \cfgnt{r}^\prime \neq \cfgnt{r}_\mathit{null} \wedge \cfgnt{r}^\prime = \cfgnt{r}_f \wedge \lp \wedge_{\lp \cfgnt{r}^{\prime}_f\ l^{\prime}\rp  \in \rho\ \lp \cfgnt{r}^{\prime}_f \neq \cfgnt{r}_f\rp } \cfgnt{r}^\prime \neq \cfgnt{r}^{\prime}_f \rp = \phi^\prime_g
    }{
      \lp \cfgnt{L}\ \cfgnt{R}\ \phi_g\ \eta\ \cfgnt{r}\ \lp \cfgt{init}\ \cfgnt{f}\ \cfgnt{k}\rp \rp  \rightarrow \\\\
      \lp \cfgnt{L}[\cfgnt{r}^\prime \mapsto \theta]\ \cfgnt{R}[ \lp l_x,\cfgnt{f}\rp  \mapsto \cfgnt{r}^\prime ]\ \phi_g^\prime\ \eta\ \cfgnt{r}\ \cfgnt{k}\rp 
	}
\and
	\inferrule[Field Access]{
      \{\lp\phi\ l\rp\} = \cfgnt{L}\lp\cfgnt{r}\rp\\
      l \neq \cfgnt{l}_\mathit{null}\\\\
      \lp \cfgnt{L}\ \cfgnt{R}\ \phi_g\ \cfgnt{r}\ \cfgnt{f}\rp \rightarrow^*_L 
...
\and
	\inferrule[Field Access]{
      \{\lp\phi\ l\rp\} = \cfgnt{L}\lp\cfgnt{r}\rp\\
      l \neq \cfgnt{l}_\mathit{null}\\\\
      \{\lp\phi^\prime\ l^\prime\rp\} = \cfgnt{L}\lp\cfgnt{R}\lp l,\cfgnt{f}\rp\rp \\
      \mathrm{fresh}_r\lp \rp  = \cfgnt{r}^\prime \\
    }{
      \lp \cfgnt{L}\ \cfgnt{R}\ \phi_g\ \eta\ \cfgnt{r}\ \lp \cfgt{*}\ \cfgt{\$}\ \cfgnt{f} \rightarrow \cfgnt{k}\rp \rp  \rightarrow \\\\
      \lp \cfgnt{L}[\cfgnt{r}^\prime \mapsto \lp\phi^\prime\ l^\prime\rp]\ \cfgnt{R}\ \phi_g\ \eta\ \cfgnt{r}^\prime\ \cfgnt{k}\rp 
	}
\and
    \inferrule[Equals (reference-true)]{
    \cfgnt{L}\lp \cfgnt{r}_0\rp = \cfgnt{L}\lp \cfgnt{r}_1\rp\\
    \phi_g \wedge \lp r_0 = r_1\rp = \phi_g^\prime}{
...
\and
	\inferrule[Field Write]{
      ...
      \lp \cfgnt{L}\ \cfgnt{R}\ \phi_g\ \eta\ \cfgnt{r}\ \lp \cfgnt{x}\ \cfgt{\$}\ \cfgnt{f}\ \cfgt{:=}\ \cfgt{*}\ \rightarrow\ \cfgnt{k}\rp \rp  \rightarrow \\\\
      \lp \cfgnt{L}^\prime\ \cfgnt{R}^\prime\ \phi_g\ \eta\ \cfgnt{r}^\prime\ \cfgnt{k}\rp 
	}	
\end{mathpar}
\end{center}
...
\begin{mathpar}
	\inferrule[Lazy Initialization]{
      ...
      \mathrm{init}_l\lp \mathrm{C}\rp  = l_f \\
      \mathrm{init}_r\lp \rp  = \cfgnt{r}_f\\\\
      \rho = \{ \lp \cfgnt{r}^\prime\ \phi^\prime\ l^\prime\rp  \mid \mathrm{isInit}\lp \cfgnt{r}^\prime\rp  \wedge \lp \phi^\prime\ l^\prime\rp  \in \cfgnt{L}\lp \cfgnt{r}^\prime\rp  \wedge \mathrm{type}\lp l^\prime\rp  = \mathrm{C} \} \\\\
...
\and
    ...
    \cfgnt{v}_0 \not\in \{\cfgt{true}, \cfgt{false}, \cfgt{null}\} \\
    \cfgnt{v}_1 \not\in \{\cfgt{true}, \cfgt{false}, \cfgt{null}\}\\\\
