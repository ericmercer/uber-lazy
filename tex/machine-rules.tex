...
%\and
	...
	\Lambda = \{ l_i | (l_i,*) \in L(r) \wedge R(l_i,f)= \emptyset\}\\
      ...
      (L\ R\ \eta\ r\ (*\ \$\ \cfgnt{f} \rightarrow k)) \rightarrow 
      (L[r_f \mapsto \theta_t]\ R[ (l_x,f) \mapsto r_f ]\ \eta\ r\ (*\ \$\ \cfgnt{f} \rightarrow k))
	}
\and
	\inferrule[New]{
...
\and
	...
	r_x = \eta(\cfgnt{x})\\
      ...
      (L[r_x \mapsto \theta_t]\ R[ (l_x,f) \mapsto r_f ]\ \eta\ \cfgnt{r}\ (\cfgnt{x}\ \cfgt{\$}\ \cfgnt{f}\ \cfgt{:=}\ \cfgnt{*})\ \rightarrow\ k))
	}	
\and
