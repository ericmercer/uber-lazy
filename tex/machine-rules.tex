...
\and
	\inferrule[Field Access (non-NULL)]{
      ...
      \rho = \{ r_a |  l_a\in L \wedge \mathrm{type}(l_a) = \mathrm{C}_r \wedge r_a = R(l,\omega)\} \\
      \phi_f = \wedge_{r_a \in \rho} r \ne r_a\\\\
      \theta_a = \{ ( l_a\ \phi_a ) | l_a\in L \wedge \mathrm{type}(l_a) = \mathrm{C}_r \wedge r_a = R(l,\omega) \wedge \phi_a = (r = r_a) \} \\\\
      \theta_f = {(l,\phi_f)}\\ 
...
\and
	...
	r_x = \eta(\cfgnt{x})\\
      ...
      \mathrm{fresh}_l(\mathrm{C}_r) = l \\\\
      \rho = \{ r_a |  l_a\in L \wedge \mathrm{type}(l_a) = \mathrm{C}_r \wedge r_a = R(l,\omega)\} \\
      \phi_f = \wedge_{r_a \in \rho} r_x \ne r_a\\\\
      \theta_a = \{ ( l_a\ \phi_a ) | l_a\in L \wedge \mathrm{type}(l_a) = \mathrm{C}_r \wedge r_a = R(l,\omega) \wedge \phi_a = (r_x = r_a) \} \\\\
      \theta_f = {(l,\phi_f)}\\ 
      \theta_t = \theta_a \cup \theta_f \\\\
      R^\prime = R[\forall \mathrm{f} \in \mathrm{C}_r\ ((l\ \cfgnt{f}) \mapsto \mathrm{fresh}_r(\mathrm{type}(\cfgnt{f})))]
    }{
