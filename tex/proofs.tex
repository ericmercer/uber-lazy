...
\subsection{Theorems}
\begin{lemma}[Location Mutual Exclusion in $\rightarrow^*_S$]
...
rule is active and $(\cfgnt{L}_1\ \cfgnt{R}_1) = (\cfgnt{L}_0\ \cfgnt{R}_0)$, which is location mutual exclusive by definition.
...
\item Any member of $\theta_\mathit{null}$, $\theta_\mathit{new}$, and
  ...
  by definition, members of $\theta_\mathit{orig}$ are location
...
left side of the transition is location mutual exclusive, and by the
