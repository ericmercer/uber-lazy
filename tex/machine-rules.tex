...
\begin{mathpar}
	\inferrule[Lazy Initialization (null)]{
      ...
      \lp \cfgnt{L}[\cfgnt{r}^\prime \mapsto \theta_\mathit{null}]\ \cfgnt{R}[ \lp l_x,\cfgnt{f}\rp  \mapsto \cfgnt{r}^\prime]\ \phi_g\ \eta\ \cfgnt{r}\ \cfgnt{k}\rp 
	}
\and
	\inferrule[Lazy Initialization (new)]{
      ...
      \lp \cfgnt{L}\ \cfgnt{R}\ \phi_g\ \eta\ \cfgnt{r}\ \lp \cfgt{init}\ \cfgnt{f}\ \cfgnt{k}\rp \rp  \rightarrow \\\\
      \lp \cfgnt{L}[\cfgnt{r}_f \mapsto \theta_\mathit{new}]\ \cfgnt{R}[ \lp l_x,\cfgnt{f}\rp  \mapsto \cfgnt{r}_f ]\ \phi_g\ \eta\ \cfgnt{r}\ \cfgnt{k}\rp 
	}
\and
	\inferrule[Lazy Initialization (alias)]{
      ...
      \mathrm{type}\lp \cfgnt{f}\rp  = \mathrm{C}\\
      \mathrm{fresh}_r\lp \rp  = \cfgnt{r}^\prime\\\\
      \{ l^\prime \mid \exists \cfgnt{r}^\prime\ \lp \mathrm{isInit}\lp \cfgnt{r}^\prime\rp  \wedge \exists \phi^\prime\ \lp \lp \phi^\prime\ l^\prime\rp  \in \cfgnt{L}\lp \cfgnt{r}^\prime\rp  \wedge \mathrm{type}\lp l^\prime\rp  = \mathrm{C}\rp\rp \} = \rho \\\\
      \{ \lp \phi_T\ l^\prime\rp \mid l^\prime \in \rho\} = \theta_\mathit{alias}\\
      \mathrm{min}_l\lp \Lambda\rp = l_x
    }{
      \lp \cfgnt{L}\ \cfgnt{R}\ \phi_g\ \eta\ \cfgnt{r}\ \lp \cfgt{init}\ \cfgnt{f}\ \cfgnt{k}\rp \rp  \rightarrow \\\\
      \lp \cfgnt{L}[\cfgnt{r}^\prime \mapsto \theta]\ \cfgnt{R}[ \lp l_x,\cfgnt{f}\rp  \mapsto \cfgnt{r}^\prime ]\ \phi_g\ \eta\ \cfgnt{r}\ \cfgnt{k}\rp 
	}
\and
