...
Certain rewrite rules depend on auxiliary on the relations in \defref{def:VS} and \defref{def:ST}, such as those in~\figref{fig:fHeap}. There are two rewrite rules in~\figref{fig:fHeap}, one for reading
