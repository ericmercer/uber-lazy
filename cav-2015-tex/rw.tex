...
arrays~\cite{GSE03,KiasanKunit,Rosner:2015}. However, these generalized symbolic execution (GSE) techniques universally require nondeterministic case-splitting during dereferencing operations, thus exacerbating the path explosion problem. Our work leverages the core idea in generalized symbolic execution
