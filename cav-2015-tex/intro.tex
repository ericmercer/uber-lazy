...
The path conditions computed by symbolic execution have two important characteristics: 
...
constraint solver.
%However, symbolic execution's precision extends only as far as the capabilities of the underlying constraint solver. 
